package com.annakhuseinova.jasperreportsspringboot.controller;

import com.annakhuseinova.jasperreportsspringboot.model.Student;
import com.annakhuseinova.jasperreportsspringboot.model.Subject;
...
public class StudentController {
    ...
    public ResponseEntity<byte[]> getReport(){
        try {
            ...
            Subject javaSubject = new Subject("Java", 80);
            Subject mysqlSubject = new Subject("MySQL", 70);
            Subject phpSubject = new Subject("PHP", 50);
            Subject mongoDbSubject = new Subject("MongoDB", 40);
            Subject cPlusPlusSubject = new Subject("C++", 60);
            List<Subject> list = new ArrayList<>();
            list.add(javaSubject);
            list.add(mysqlSubject);
            list.add(phpSubject);
            list.add(mongoDbSubject);
            list.add(cPlusPlusSubject);
    ...
    public static JRBeanCollectionDataSource getSubDataSource(){
        Student student1 = new Student(1L, "Raj", "Joshi", "happy Street", "Dehli");
